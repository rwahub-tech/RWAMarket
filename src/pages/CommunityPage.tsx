...
export default function CommunityPage() {
  const assets = useMockDataStore((state) => state.assets);
        ...
        <section className="bg-white rounded-xl shadow-sm p-8 mb-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            ...
            >
              ...
              <h3 className="font-semibold text-lg mb-2">{assets.length}</h3>
              <p className="text-neutral-600">Listed assets</p>
            </motion.div>
            ...
            >
              ...
              <h3 className="font-semibold text-lg mb-2">{validators.length}</h3>
              <p className="text-neutral-600">Active validators</p>
            </motion.div>
