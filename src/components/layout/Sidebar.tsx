...
import { ChevronLeft, ChevronRight, Package, Layers, Shield, Home, LayoutDashboard, User, LogOut } from 'lucide-react';
        ...
        <ul className="space-y-2">
          {navItems.map((item) => (
            <motion.li
              ...
              whileHover="hover"
              animate={location.pathname === item.path ? 'active' : 'idle'}
              className="group"
            >
              <Link
                to={item.path}
